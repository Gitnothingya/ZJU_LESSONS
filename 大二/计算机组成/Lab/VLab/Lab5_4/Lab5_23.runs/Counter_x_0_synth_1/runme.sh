...
HD_PWD='D:/Vteacher/Lab5_23/Lab5_23.runs/Counter_x_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Counter_x_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Counter_x_0.tcl
