...
# test I type
    addi    a0, zero, 7     # a0 = 0x0000_0007 00700513 0000 0000 0111 0000 0000 0101 0001 0011
...
# test R type
    ...
    and     s8, a0, a2      # s8 = 0x0000_0001    pc = 44
...
# test LW and SW
    ...
    lw      a0, 4(zero)     # a0 = 0x2468_acf0    pc = 54
    
    bne     a0, a1, bne_target  # branch出错
    beq     zero, zero, end
