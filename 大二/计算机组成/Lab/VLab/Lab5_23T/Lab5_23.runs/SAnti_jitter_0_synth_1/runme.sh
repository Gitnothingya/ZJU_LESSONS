...
HD_PWD='D:/Vteacher/Lab5_23/Lab5_23.runs/SAnti_jitter_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SAnti_jitter_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SAnti_jitter_0.tcl
