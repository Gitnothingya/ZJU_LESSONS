...
HD_PWD='D:/Vteacher/Lab5_23/Lab5_23.runs/MIO_BUS_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MIO_BUS_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MIO_BUS_0.tcl
