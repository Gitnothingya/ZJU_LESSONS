...
HD_PWD='D:/Vteacher/Lab5_23/Lab5_23.runs/SPIO_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPIO_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPIO_0.tcl
