...
if { ${design_name} eq "" } {
  ...
  set_property USER_COMMENTS.comment_0 "ALU_operation[2]" [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_1 "addc[31:0]" [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_2 "addc[32]" [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_3 "30'b0" [get_bd_designs $design_name]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net or_bit_32_0_o [get_bd_ports zero] [get_bd_pins or_bit_32_0/o]
  connect_bd_net -net s_0_1 [get_bd_ports ALU_operation] [get_bd_pins MUX8T1_32_0/s] [get_bd_pins xlslice_1/Din]
