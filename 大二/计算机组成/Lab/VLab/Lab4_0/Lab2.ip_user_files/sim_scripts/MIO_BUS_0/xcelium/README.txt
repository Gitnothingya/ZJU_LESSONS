...
#
# Generated by export_simulation on Thu Mar 24 12:41:54 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './MIO_BUS_0.sh' script.

./MIO_BUS_0.sh -reset_run
...
./MIO_BUS_0.sh -noclean_files

For more information on the script, please type './MIO_BUS_0.sh -help'.
