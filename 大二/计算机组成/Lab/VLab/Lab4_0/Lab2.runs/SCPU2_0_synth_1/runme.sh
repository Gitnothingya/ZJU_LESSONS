...
HD_PWD='D:/Vteacher/Lab4_0/Lab2.runs/SCPU2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SCPU2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SCPU2_0.tcl
