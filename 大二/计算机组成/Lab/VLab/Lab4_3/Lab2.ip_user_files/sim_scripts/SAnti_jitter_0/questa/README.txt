...
#
# Generated by export_simulation on Thu Mar 24 12:37:49 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './SAnti_jitter_0.sh' script.

./SAnti_jitter_0.sh -reset_run
...
./SAnti_jitter_0.sh -noclean_files

For more information on the script, please type './SAnti_jitter_0.sh -help'.
