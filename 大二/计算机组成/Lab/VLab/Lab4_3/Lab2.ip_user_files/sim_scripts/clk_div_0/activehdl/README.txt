...
#
# Generated by export_simulation on Thu Mar 24 12:39:38 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './clk_div_0.sh' script.

./clk_div_0.sh -reset_run
...
./clk_div_0.sh -noclean_files

For more information on the script, please type './clk_div_0.sh -help'.
