...
HD_PWD='D:/Vteacher/Lab2/Lab2.runs/SCPU_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SCPU_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SCPU_0.tcl
