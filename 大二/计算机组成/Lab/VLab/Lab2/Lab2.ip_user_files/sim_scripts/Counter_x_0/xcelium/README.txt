...
#
# Generated by export_simulation on Thu Mar 24 12:41:36 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './Counter_x_0.sh' script.

./Counter_x_0.sh -reset_run
...
./Counter_x_0.sh -noclean_files

For more information on the script, please type './Counter_x_0.sh -help'.
