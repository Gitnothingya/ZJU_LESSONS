...
HD_PWD='D:/Vteacher/Cctrl/Cctrl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_ctrl.tcl
