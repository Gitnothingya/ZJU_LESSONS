...
HD_PWD='D:/Vteacher/IP/CPU/SCPU2/SCPU2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SCPU2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SCPU2.tcl
