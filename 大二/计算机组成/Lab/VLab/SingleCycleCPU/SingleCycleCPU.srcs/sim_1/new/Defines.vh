...
`define CSR_MRET                          32'hF000_0000
`define CSR_NORMAL                        32'hFFFF_FFFF
...
`define IMM_J  3'b100
`define IMM_U  3'b000
`define IMM_Z  3'b101 //中断指令零拓展
`define IMM_N  3'b111 //无需立即数
...
`define VGA_DBG_Core_Assignments \
    ...
    assign dbg_mem_wen = mem_wen; \
    assign dbg_mem_ren = mem_ren; \
