...
#
# Generated by export_simulation on Wed Mar 30 21:11:28 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './orl_0.sh' script.
...
./orl_0.sh -noclean_files

For more information on the script, please type './orl_0.sh -help'.
