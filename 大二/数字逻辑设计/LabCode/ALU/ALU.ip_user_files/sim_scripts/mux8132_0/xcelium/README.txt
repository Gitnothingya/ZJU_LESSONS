...
#
# Generated by export_simulation on Tue Mar 15 22:23:21 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './mux8132_0.sh' script.

./mux8132_0.sh -reset_run
...
./mux8132_0.sh -noclean_files

For more information on the script, please type './mux8132_0.sh -help'.
