...
#
# Generated by export_simulation on Tue Mar 15 22:24:02 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './srl_0.sh' script.
...
./srl_0.sh -noclean_files

For more information on the script, please type './srl_0.sh -help'.
