...
#
# Generated by export_simulation on Tue Mar 15 22:23:10 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './adc_1.sh' script.
...
./adc_1.sh -noclean_files

For more information on the script, please type './adc_1.sh -help'.
